...
describe('calculateNumber', () => {
  it('should return the sum of two positive values', () => {
    const result = calculateNumber(1, 3);
    assert.strictEqual(result, 4);
  });

  it('should return the sum of one positive value and one negtive value', () => {
    const result = calculateNumber(1, -5);
    assert.strictEqual(result, -4);
  });

  it('should return the sum of rounded values of one negative and one positive number', () => {
    const result = calculateNumber(1.5, -3);
    assert.strictEqual(result, -1);
  });

  it('should return the sum of rounded values of two negative numbers', () => {
    const result = calculateNumber(-1.5, -2.8);
    assert.strictEqual(result, -4);
  });

  it('should return the sum of rounded values of two positive numbers', () => {
  ...
  it('should handle very larg negative integers', () => {
    const result = calculateNumber(-1e12, -1e12);
    assert.strictEqual(result, -2e12);
  ...
  it('should handle a mix of larg positive and negative integers', () => {
    const result = calculateNumber(1e12, -1e12);
    assert.strictEqual(result, 0);
    // 1,000,000,000,000 + -1,000,000,000,000
  });
